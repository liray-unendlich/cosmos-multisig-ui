...
describe("addresses", () => {
  describe("pubkeyToRawAddress", () => {
    ...
    it("works for Ed25519", () => {
      const pubkey = {
        ...
        value: toBase64(
          fromHex("12ee6f581fe55673a1e9e1382a0829e32075a0aa4763c968bc526e1852e78c95"),
        ),
      };
      expect(pubkeyToRawAddress(pubkey)).toEqual(
    ...
    it("works for multisig", () => {
      ...
      expect(pubkeyToRawAddress(testgroup1)).toEqual(
        fromHex("0892a77fab2fa7e192c3b7b2741e6682f3abb72f"),
      );
    });
  });
  ...
  describe("pubkeyToAddress", () => {
    it("works for Secp256k1", () => {
      ...
      expect(pubkeyToAddress(pubkey, prefix)).toEqual(
    ...
    it("works for multisig", () => {
      ...
      expect(pubkeyToAddress(testgroup1, "wasm")).toEqual(
        "wasm1pzf2wlat97n7rykrk7e8g8nxste6hde0r8jqsy",
      );
    });
  });
});
