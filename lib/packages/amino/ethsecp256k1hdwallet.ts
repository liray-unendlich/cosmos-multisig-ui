 ...
 * All fields in here must be JSON types.
 */
interface EthSecp256k1HdWalletData {
...
const defaultOptions: EthSecp256k1HdWalletOptions = {
  bip39Password: "",
  hdPaths: [makeEthPath(0)],
  prefix: "haqq",
};

export class EthSecp256k1HdWallet implements OfflineAminoSigner {
  /**
  ...
  public static async fromMnemonic(
    mnemonic: string,
    options: Partial<EthSecp256k1HdWalletOptions> = {},
  ...
  protected constructor(
    ...
    options: EthSecp256k1HdWalletConstructorOptions,
  ) {
  ...
  public async signAmino(signerAddress: string, signDoc: StdSignDoc): Promise<AminoSignResponse> {
    ...
    const message = keccak256(serializeSignDoc(signDoc));
    ...
    return {
      signed: signDoc,
      signature: encodeEthSecp256k1Signature(pubkey, signatureBytes),
    };
  }
  ...
  public async serializeWithEncryptionKey(
    ...
    const dataToEncrypt: EthSecp256k1HdWalletData = {
    ...
    const out: EthSecp256k1HdWalletSerialization = {
