...
describe("encoding", () => {
  describe("encodeSecp256k1Pubkey", () => {
    ...
    it("throws for uncompressed public keys", () => {
      ...
      expect(() => encodeSecp256k1Pubkey(pubkey)).toThrowError(
  ...
  describe("decodeAminoPubkey", () => {
    ...
    it("works for multisig", () => {
      ...
      expect(() => decodeAminoPubkey(fromHex("22C1F7E20705"))).toThrowError(
        /expecting 0x08 prefix/i,
      );
    });
  });
  ...
  describe("decodeBech32Pubkey", () => {
    ...
    it("works for enigma pubkey", () => {
      expect(
        decodeBech32Pubkey(
          "enigmapub1addwnpepqw5k9p439nw0zpg2aundx4umwx4nw233z5prpjqjv5anl5grmnchzp2xwvv",
        ),
      ).toEqual({
        type: "tendermint/PubKeySecp256k1",
