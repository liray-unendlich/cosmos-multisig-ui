...
export function isMsgMigrateEncodeObject(
  ...
  return (
    (object as MsgMigrateContractEncodeObject).typeUrl === "/cosmwasm.wasm.v1.MsgMigrateContract"
  );
}
...
export function isMsgExecuteEncodeObject(
  ...
  return (
    (object as MsgExecuteContractEncodeObject).typeUrl === "/cosmwasm.wasm.v1.MsgExecuteContract"
  );
}
