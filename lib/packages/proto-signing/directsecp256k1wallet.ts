...
import { Secp256k1, sha256 } from "@/lib/packages/crypto";
import {
  fromBase64,
  fromHex,
  fromUtf8,
 ...
 */
export interface DirectSecp256k1WalletSerialization {
 ...
 * All fields in here must be JSON types.
 */
interface DirectSecp256k1WalletData {
...
export class DirectSecp256k1Wallet implements OfflineDirectSigner {
  ...
  public async serializeWithEncryptionKey(
    ...
    const dataToEncrypt: DirectSecp256k1WalletData = {
    ...
    const out: DirectSecp256k1WalletSerialization = {
