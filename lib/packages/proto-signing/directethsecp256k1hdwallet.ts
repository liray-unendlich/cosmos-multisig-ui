 ...
 */
export interface DirectEthSecp256k1HdWalletSerialization {
 ...
 */
interface EthSecp256k1Derivation {
 ...
 * All fields in here must be JSON types.
 */
interface DirectEthSecp256k1HdWalletData {
...
interface DirectEthSecp256k1HdWalletConstructorOptions
  extends Partial<DirectEthSecp256k1HdWalletOptions> {
  readonly seed: Uint8Array;
}

const defaultOptions: DirectEthSecp256k1HdWalletOptions = {
  bip39Password: "",
  hdPaths: [makeEthPath(0)],
  prefix: "aioz",
};
...
export class DirectEthSecp256k1HdWallet implements OfflineDirectSigner {
  ...
  public static async fromMnemonic(
    mnemonic: string,
    options: Partial<DirectEthSecp256k1HdWalletOptions> = {},
  ...
  public static async deserialize(
    ...
    switch ((root as any).type) {
      case serializationTypeV1:
        return DirectEthSecp256k1HdWallet.deserializeTypeV1(serialization, password);
      default:
        throw new Error("Unsupported serialization type");
    }
  }
  ...
  private static async deserializeTypeV1(
    ...
    return DirectEthSecp256k1HdWallet.deserializeWithEncryptionKey(serialization, encryptionKey);
  }
  ...
  private readonly accounts: readonly EthSecp256k1Derivation[];

  protected constructor(
    mnemonic: EnglishMnemonic,
    options: DirectEthSecp256k1HdWalletConstructorOptions,
  ) {
  ...
  public async getAccounts(): Promise<readonly AccountData[]> {
    ...
    return accountsWithPrivkeys.map(({ algo, pubkey, address, addressHex }) => ({
      algo: algo,
      pubkey: pubkey,
      address: address,
  ...
  public async serializeWithEncryptionKey(
    ...
    const dataToEncrypt: DirectEthSecp256k1HdWalletData = {
    ...
    const out: DirectEthSecp256k1HdWalletSerialization = {
