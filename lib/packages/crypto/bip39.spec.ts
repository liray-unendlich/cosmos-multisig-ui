import { fromAscii, fromBase64, fromHex } from "@/lib/packages/encoding";
  ...
  describe("wordlist", () => {
    it("matches the words from the bitcoin/bips/bip-0039 spec", () => {
      ...
      expect(checksum).toEqual(
        fromHex("2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda"),
      );
