import { fromHex } from "@/lib/packages/encoding";
...
describe("Secp256k1Signature", () => {
  ...
  it("can decode from DER", () => {
    ...
    expect(sig70.r()).toEqual(
      fromHex("626D61B7BE1488B563E8A85BFB623B2331903964B5C0476C9F9AD29144F076FE"),
    );
    expect(sig70.s()).toEqual(
      fromHex("2002A2C0AB5E48626BF761CF677DFEEDE9C7309D2436D4B8C2B89F21EE2EBC6A"),
    );
    ...
    expect(sig71.r()).toEqual(
      fromHex("F25B86E1D8A11D72475B3ED273B0781C7D7F6F9E1DAE0DD5D3EE9B84F3FAB891"),
    );
    expect(sig71.s()).toEqual(
      fromHex("63D9C4E1391DE077244583E9A6E3D8E8E1F236A3BF5963735353B93B1A3BA935"),
    );
    ...
    expect(sig72.r()).toEqual(
      fromHex("83DE9BE443BCF480892B8C8CA1D5EE65C79A315642C3F7B5305AFF3065FDA278"),
    );
    expect(sig72.s()).toEqual(
      fromHex("9747932122B93CEC42CAD8EE4630A8F6CBE127578B8C495B4AB927275F657658"),
    );
  });
});
...
describe("ExtendedSecp256k1Signature", () => {
  ...
  it("throws for recovery param out of range", () => {
    expect(
      () => new ExtendedSecp256k1Signature(fromHex("aa"), fromHex("bb"), Number.NaN),
