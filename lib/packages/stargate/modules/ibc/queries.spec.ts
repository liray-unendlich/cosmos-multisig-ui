...
async function makeClientWithIbc(
  rpcUrl: string,
): Promise<[QueryClient & IbcExtension, Tendermint34Client]> {
  ...
  describe("channel", () => {
    ...
    describe("packetCommitments", () => {
      it("works", async () => {
        ...
        const response = await client.ibc.channel.packetCommitments(
          ibcTest.portId,
          ibcTest.channelId,
        );
    ...
    describe("allPacketCommitments", () => {
      it("works", async () => {
        ...
        const response = await client.ibc.channel.allPacketCommitments(
          ibcTest.portId,
          ibcTest.channelId,
        );
        expect(response.commitments).toEqual([ibcTest.packetState]);
    ...
    describe("packetReceipt", () => {
      it("works", async () => {
        ...
        const response = await client.ibc.channel.packetReceipt(
          ibcTest.portId,
          ibcTest.channelId,
          1,
        );
    ...
    describe("packetAcknowledgements", () => {
      it("works", async () => {
        ...
        const response = await client.ibc.channel.packetAcknowledgements(
          ibcTest.portId,
          ibcTest.channelId,
        );
