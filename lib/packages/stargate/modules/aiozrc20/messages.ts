...
import {
  MsgConvertAIOZRC20,
  MsgConvertCoin,
} from "@/lib/packages/cosmjs-types/aioz/aiozrc20/v1/tx";
...
export function isMsgConvertCoinEncodeObject(
  ...
  return (
    (encodeObject as MsgConvertCoinEncodeObject).typeUrl === "/aioz.aiozrc20.v1.MsgConvertCoin"
  );
}
...
export function isMsgConvertAIOZRC20EncodeObject(
  ...
  return (
    (encodeObject as MsgConvertAIOZRC20EncodeObject).typeUrl ===
