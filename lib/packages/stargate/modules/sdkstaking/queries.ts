...
} from "@/lib/packages/cosmjs-types/cosmos/staking/v1beta1/query";
import { BondStatus } from "@/lib/packages/cosmjs-types/cosmos/staking/v1beta1/staking";
...
export interface SdkStakingExtension {
  readonly staking: {
    delegation: (
...
export function setupSdkStakingExtension(base: QueryClient): SdkStakingExtension {
