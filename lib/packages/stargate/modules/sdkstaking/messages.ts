...
export function isMsgBeginRedelegateEncodeObject(
  ...
  return (
    (o as MsgBeginRedelegateEncodeObject).typeUrl === "/cosmos.staking.v1beta1.MsgBeginRedelegate"
  );
}
...
export function isMsgCreateValidatorEncodeObject(
  ...
  return (
    (o as MsgCreateValidatorEncodeObject).typeUrl === "/cosmos.staking.v1beta1.MsgCreateValidator"
  );
}
