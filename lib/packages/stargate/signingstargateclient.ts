...
export class SigningStargateClient extends StargateClient {
  ...
  public async delegateTokens(
    ...
    return this.signAndBroadcast(
      hexToAddress(delegatorAddress, this.prefix),
      [delegateMsg],
      fee,
      memo,
    );
  ...
  public async sendIbcTokens(
    ...
    return this.signAndBroadcast(
      hexToAddress(senderAddress, this.prefix),
      [transferMsg],
      fee,
      memo,
    );
  ...
  private async signAmino(
    ...
    console.log("signAmino account", { account });
    const pubkey =
    ...
    console.log("signAmino pubkey", { account });
    ...
    console.log({ signedTxBodyBytes, signedGasLimit, signedSequence, signedAuthInfoBytes });
