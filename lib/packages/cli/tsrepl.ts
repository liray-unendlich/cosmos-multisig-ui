...
export class TsRepl {
  ...
  public async start(): Promise<REPLServer> {
    ...
    //   '/usr/lib/nodejs' ]
    // However, this does not include the installation path of @/lib/packages/cli because
    ...
    repl.defineCommand("type", {
      ...
      action: (identifier: string) => {
        ...
        const identifierFirstPosition =
          this.evalData.input.length - identifierTypeScriptCode.length;
